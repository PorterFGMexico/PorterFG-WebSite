...
try {
	...
	if (!function_exists('posix_getuid')) {
		echo "The posix extensions are required - see https://php.net/manual/en/book.posix.php" . PHP_EOL;
		exit(1);
	}
	$user = posix_getuid();
	...
	if (!function_exists('pcntl_signal') && !in_array('--no-warnings', $argv)) {
		echo "The process control (PCNTL) extensions are required in case you want to interrupt long running commands - see https://php.net/manual/en/book.pcntl.php" . PHP_EOL;
	}
